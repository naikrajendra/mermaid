# Cisco IT Order-to-Cash Mermaid Diagrams

This folder contains Mermaid diagrams for a order-to-cash business process covering subscription, license, services, and hardware lines.

## Recommended VS Code extensions for local rendering
...
After installation, open any .mmd file and use the preview command to render the diagram locally.

## Files in this folder

- [order-to-cash-consolidated.mmd](order-to-cash-consolidated.mmd) — end-to-end process flow
- [order-to-cash-c4.mmd](order-to-cash-c4.mmd) — C4-style system context view
- [order-to-cash-architecture.mmd](order-to-cash-architecture.mmd) — enterprise architecture integration view
- [index.html](index.html) — one-click browser preview of all 3 diagrams
...
Open [index.html](index.html) in a browser for a one-click preview of all 3 diagrams.

### VS Code preview

1. Install a Mermaid extension in VS Code
2. Open any .mmd file in this folder
3. Use the preview command or markdown preview

### GitHub rendering

These Mermaid blocks are ready to paste into GitHub README files or markdown documents.

## Business line coverage

- Subscription: contract, entitlement, recurring billing
- License: SKU validation, key generation, compliance
- Services: SOW, delivery, milestone billing
- Hardware: inventory, shipping, delivery, invoice
